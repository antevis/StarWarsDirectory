...
struct  MovieCharacter {
	...
	let films: [Film] // An array of film resource URLs that this person has been in.
	let species: [Species] // An array of species resource URLs that this person belonds to.
	let vehicles: [Vehicle] // An array of vehicle resource URLs that this person has piloted.
	let starships: [Starship] // An array of starship resource URLs that this person has piloted.
